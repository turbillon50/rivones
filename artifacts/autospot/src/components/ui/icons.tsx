...
export function IconHeart({ size = 14, className, filled }: IconProps & { filled?: boolean }) {
  return (
...
export function IconStar({ size = 12, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" className={className}>
...
export function IconSettings2({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06A1.65 1.65 0 0015 19.4V20a2 2 0 01-4 0v-.09a1.65 1.65 0 00-1.82-.33h-.09A1.65 1.65 0 008 19.4l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 005.6 15H4a2 2 0 010-4h.09A1.65 1.65 0 005.17 9l-.06-.06A2 2 0 017.94 6.1l.06.06a1.65 1.65 0 001.82.33H10a2 2 0 014 0h.09" />
    </svg>
  );
}

export function IconFuel({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 22V5a2 2 0 012-2h8a2 2 0 012 2v17" />
      <path d="M15 10h2a2 2 0 012 2v2a2 2 0 004 0V8l-4-4" />
      <path d="M7 10h4" />
    </svg>
  );
}
...
export function IconTruck({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconDroplet({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconNavigation({ size = 20, className }: IconProps) {
  return (
...
export function IconLoader({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className={cn("animate-spin", className)}>
...
export function IconCar({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3C13.3 7.3 12.7 7 12 7H5c-.6 0-1.1.4-1.4.9L2.2 10.8A3.7 3.7 0 002 12v4c0 .6.4 1 1 1h2" />
...
export function IconTransmission({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="3" />
